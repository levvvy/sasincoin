...
"""Verify that starting sasincoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sasincoin with -h for help text")
        ...
        self.log.info("Start sasincoin with -version for version information")
