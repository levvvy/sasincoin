...
{
    const char* pszTimestamp = "Sasincoin powstal 19-10-2020";
    const CScript genesisOutputScript = CScript() << ParseHex("046501BD21E9B02424EDCFEAFA77ACEBFC429F79717BC9023D27BCC4C3E324330BC4C7E2E6A644CCA3D83C89D180418A8501743EEA83316DADED4D425ADFB14570") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("b3b4b3c1e785f4e0fe8847f127d8fa8dc4b426be0d338b64118d48e0f41e95f7");
        ...
        consensus.defaultAssumeValid = uint256S("0xb3b4b3c1e785f4e0fe8847f127d8fa8dc4b426be0d338b64118d48e0f41e95f7"); //1441280
        ...
        genesis = CreateGenesisBlock(1603123000, 1290883, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb3b4b3c1e785f4e0fe8847f127d8fa8dc4b426be0d338b64118d48e0f41e95f7"));
        assert(genesis.hashMerkleRoot == uint256S("0x31d12a2ef642a44467cd91eacc00952b6387737b3af196542d79c490495ea8a4"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("seed-a.sasincoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.sasincointools.com");
        //vSeeds.emplace_back("dnsseed.sasincoinpool.org");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xe6c4866c8a3fea4cc9ea651a331714f1a19c7ce927ec33610f890794ec57a442"); //612653
        ...
        genesis = CreateGenesisBlock(1486949366, 408601, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe6c4866c8a3fea4cc9ea651a331714f1a19c7ce927ec33610f890794ec57a442"));
        assert(genesis.hashMerkleRoot == uint256S("0x31d12a2ef642a44467cd91eacc00952b6387737b3af196542d79c490495ea8a4"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.sasincointools.com");
        //vSeeds.emplace_back("seed-b.sasincoin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc75f6f380892ad5b29dcef7d98f3229f510bee86927f7ca5485c6599c0d14502"));
        assert(genesis.hashMerkleRoot == uint256S("0x31d12a2ef642a44467cd91eacc00952b6387737b3af196542d79c490495ea8a4"));
