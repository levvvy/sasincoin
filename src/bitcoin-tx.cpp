...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s sasincoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  sasincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded sasincoin transaction") + "\n" +
              "  sasincoin-tx [options] -create [commands]   " + _("Create hex-encoded sasincoin transaction") + "\n" +
              "\n";
