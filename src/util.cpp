...
const char * const BITCOIN_CONF_FILENAME = "sasincoin.conf";
const char * const BITCOIN_PID_FILENAME = "sasincoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SasinCoin";
#else
    // Unix
